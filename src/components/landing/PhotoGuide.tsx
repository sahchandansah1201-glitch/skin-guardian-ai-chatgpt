  ...
  return (
    <section id="photo-guide" className="section-padding bg-card" aria-labelledby="photo-title">
      <div className="container mx-auto max-w-4xl">
        ...
        <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6" stagger={0.08}>
          {rules.map((r, i) => (
            <StaggerItem key={r.title}>
              <div className="bg-background rounded-2xl p-5 shadow-soft text-center h-full">
